...
func checkForRelease(bugs: Int, music: Bool, levels: Int) {
    if bugs < 10 && music && levels > 5 {
        ...
        if bugs >= 10 {
            ...
            print("Game must have music!")
        } else if levels <= 5 {
            print("Game must have more than 5 levels!")
        } else {
...
func checkTrainingStatus(name: String, bike: Bool, run: Bool) {
    if bike && run {
        print("Well \(name), looks like you are ready to go")
    } else if !bike && run {
        print("Well \(name), looks like you need to go for a bike ride")
    } else if bike && !run {
        print("Well \(name), looks like you need to go for a run")
    } else {
        print("Well \(name), looks like you need to go for a bike ride and a run")
    }
}
