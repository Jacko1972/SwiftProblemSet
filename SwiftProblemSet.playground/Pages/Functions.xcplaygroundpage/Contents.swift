...
func beginsWithVowel(word : String) -> Bool {
    ...
    let firstLetter : String = String(word.characters[word.startIndex])
    if vowels.index(of: firstLetter) != nil {
        return true
    } else {
        return false
    }
 ...
 */
func funWithWords(sentence : String) -> String {
    if beginsWithVowel(word: sentence) {
 ...
 funWithWords(sentence: "Apples") // "APPLES"
 funWithWords(sentence: "pIG") // "pig"
 funWithWords(sentence: "oink") // "OINK"
 funWithWords(sentence: "udacity") // "UDACITY"
 funWithWords(sentence: "") // ""
