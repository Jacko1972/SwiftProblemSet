...
let firstString : String = "Uda"
let secondString : String = "city"
print("\(firstString)city courses test your mental capa\(secondString)")
//: ### Exercise 7
//: Write code that deletes all occurrences of the word "like" in the following string.
let lottaLikes = "If like, you wanna learn Swift, like, you should build lots of small apps, cuz it's like, a good way to practice."
print (lottaLikes.replacingOccurrences(of: "like", with: "")) // ugly with shocking grammar
print (lottaLikes.replacingOccurrences(of: "like, ", with: "")) // pretty, except for cuz
//: ### Exercise 8
...
var weeklyEarningsString = "On average, millenials spend \(Int(averageRent/averageMonthlyEarnings*100))% of their income on rent."
/*:
 ****
 [Table of Contents](Table%20of%20Contents) | [Previous](@previous) | [Next](@next)
 */
